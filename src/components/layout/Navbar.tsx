    ...
    <header className='h-14 md:h-[67px] bg-white w-full '>
      <div className='container mx-auto h-full flex items-center justify-end text-[#05060F99] gap-4 md:gap-6 px-3 md:px-0'>
        ...
        <button className='relative p-1'>
          ...
          <samp className='bg-red-500 text-white text-[10px] font-medium rounded-full absolute -top-1.5 -right-1 aspect-square w-[18px] h-[18px] flex items-center justify-center'>
            21
          </samp>
        </button>
        ...
        <div className='flex items-center gap-1 cursor-pointer'>
          <Icon
            icon={userIcon}
            className='w-4 h-4 p-1 border-2 border-primary rounded-full'
          />
          <Icon icon={downIcon} className='w-3 text-xs' />
        </div>
      </div>
